...
<%@page import="com.jubging.domain.JgbukDAO"%>
<%@page import="java.util.List"%>
<%@page import="com.jubging.domain.jgbuk"%>
...
<%
JgbukDAO dao = new JgbukDAO();
List<jgbuk> jeonbuk = dao.Selectjb();
%>
		...
		<div class="board_list_wrap">
			<table class="board_list">
				...
				<tbody>
					...
					%>
					<tr>
						<td class="num"><%=jeonbuk.get(i).getJb_idx()%></td>


						<td class="tit"><a href="<%=jeonbuk.get(i).getJb_ringk()%>"><%=jeonbuk.get(i).getJb_name()%></a></td>
						<td>관리자</td>
						<td>2023-03-30</td>
					</tr>
					<%
