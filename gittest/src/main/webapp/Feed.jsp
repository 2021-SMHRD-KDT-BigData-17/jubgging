      ...
      <form action="">
        <div class="input_box">
          <div class="postbox_area">
            ...
            <div class="input editable" contenteditable="true" spellcheck="false" name="c_content"></div> 
        ...
        <div class="title">
          ...
          <div class="tag_content">
            ...
            <div class="tag_details">
              <p><span>_</span>개의 태그까지 추가할 수 있습니다</p>
              <button id="add_postboxTags" onclick="addTags()">태그 추가</button>
