  ...
  <div class="profile_header">
    ...
    <div class="follow_bx">
      <div class = "trend_for_you">
          ...
          <div class="trend_bx">
            <div class="rate">
              <li><a href="#">#today weather <br><p>9.7k posts</p></a></li>
              <div class="interest">
            ...
            <div class="rate">
              <li><a href="#">#plogging <br><p>1.37k posts</p></a></li>
              <div class="interest">
                <button class="smile"><i class="fas fa-smile"></i> Interested</button>
                <button class="frown"><i class="fas fa-frown"></i> Not Interested</button>
              </div>
            ...
            <div class="rate">
              <li><a href="#">#dongcheon <br><p>3.2k posts</p></a></li>
              <div class="interest">
                <button class="smile"><i class="fas fa-smile"></i> Interested</button>
                <button class="frown"><i class="fas fa-frown"></i> Not Interested</button>
              </div>
            ...
            <div class="rate">
              <li><a href="#">#분리수거 <br><p>7.1k posts</p></a></li>
              <div class="interest">
                <button class="smile"><i class="fas fa-smile"></i> Interested</button>
                <button class="frown"><i class="fas fa-frown"></i> Not Interested</button>
              </div>
            ...
            <div class="rate">
              <li><a href="#">#떡잎마을 방범대 <br><p>3.1k posts</p></a></li>
              <div class="interest">
                <button class="smile"><i class="fas fa-smile"></i> Interested</button>
                <button class="frown"><i class="fas fa-frown"></i> Not Interested</button>
              </div>
